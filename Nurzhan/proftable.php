...
<head></head>
<body>
			    <h2><span> Edit the data or delete</span></h2>
...
<tr>
	...
	<th>Description</th>
	<th>University for profession</th>
	    <th>Edit</th>	
    <th>Delete</th>	
</tr>
 <?php 
$mysqli = new mysqli("localhost", "root", "", "proforientationdb");
if($is_admin){
	
	$sql = "select * from profession_code";
	
}else{
	$user_id = $_SESSION['user_id'];
	$sql = "select * from profession_code WHERE `author_id` = $user_id";
}
...
foreach($data as $row){
echo "<tr><td>$row[Profession_code]</td>";
echo "<td>$row[Name_profession]</td>";
echo "<td>$row[Profession_describtion]</td>";
echo "<td>$row[University_for_profession]</td>";
echo "<td><a href='edit.php?id=$row[Profession_code]'>Edit</a></td>";
echo "<td><a href='del_data.php?id=$row[Profession_code]'>Delete</a></td></tr>";
} 
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="National.php">Rating universities of Kazakhstan for 2016</a></li>
