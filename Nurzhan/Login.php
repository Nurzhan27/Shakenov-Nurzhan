...
<html>
<head>
<title>Proforientation | Login</title>
    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <div class="clr"></div>
          <form action="auth/login.php" method="post" id="sendemail">
            <ol>
              <li>
                <label for="name">Login (required)</label>
                <input id="name" name="login" class="text" required />
              </li>
              <li>
                <label for="message">password</label>
                <input id="message" name="password" type="password" required>
              </li>
			<li>
				<input type='submit'>
			</li>
