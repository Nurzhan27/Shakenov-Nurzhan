...
$res=$mysqli->query("select * from id_university") ;
$data = array();
...
foreach($data as $row){
echo "<tr><td>$row[User ID ]</td>";
echo "<td>$row[ID University]</td>";
echo "<td>$row[University name]</td>";
echo "<td>$row[University description]</td>";
echo "<td>$row[Profession code]</td>";
echo "<td>$row[University type]</td>";
echo "<td><a href='edit1.php?id=$row[User ID ]'>Edit</a></td>";
echo "<td><a href='del_data1.php?id=$row[User ID ]'>Delete</a></td></tr>";
} 
