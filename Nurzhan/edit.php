      ...
      <div class="mainbar"> 
		<div class="article">
			<?php 
                ...
                $ProfID=$_GET['id']; 
                $result=$mysqli->query("select * from profession_code WHERE Profession_code='$ProfID'"); 
				IF (!$result){ 
				...
				<html>
					...
					<body>
						...
						<form method="post" action="editing.php"> 
							<input type="hidden" name="profID" value="<?=$row['Profession_code']?>" required> 
							<br> 
							Profession name: <input type="text" method="text" name="nameprof" value="<?=$row['Name_profession']?>" required> 
							<br> <br> 
							Description of profession: <input type="text" method="text" name="desprof" value="<?=$row['Profession_describtion']?>" required> 
							<br> <br> 
							University for profession: <input type="text" method="text" name="univerprof" value="<?=$row['University_for_profession']?>" required> 
							<br> <br> 
