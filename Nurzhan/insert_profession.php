...
<?php
    ...
    $profname = mysqli_real_escape_string($link, $_POST['profname']);
    $profdes = mysqli_real_escape_string($link, $_POST['profdes']);
    $profuniver = mysqli_real_escape_string($link, $_POST['profuniver']);
    mysql_connect("localhost", "root", "") or die (mysql_error());
    mysql_select_db("proforientationdb") or die(mysql_error());
    $sel = "SELECT * FROM profession_code WHERE Name_profession = '$profname'";
    $res = mysql_query($sel); 
    $num = mysql_num_rows($res);
    $user_id = $_SESSION['user_id'];
    $query = "INSERT INTO `profession_code`(`Name_profession`, `Profession_describtion`, `University_for_profession`, `author_id`) VALUES ('$profname','$profdes','$profuniver',$user_id)";
    $result = mysql_query ( $query );
	if ($result) 
	{
		header("Location: proftable.php");
	} 
    else
    {
