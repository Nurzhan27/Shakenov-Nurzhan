<html>
<head>
<title>Proforientation | Register</title>
    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <div class="clr"></div>
          <form action="auth/register.php" method="post" id="sendemail">
            <ol>
              <li>
                <label for="name">Login </label>
                <input id="name" name="login" class="text" required />
              </li>
              <li>
              ...
              <li>
                ...
                <input id="website" name="full_name" class="text" required />
              </li>
              <li>
                <label for="message">password</label>
                <input id="message" name="password" type="password" required pattern="{6,20})
" >
              </li>
			<li>
				<input type='submit'>
