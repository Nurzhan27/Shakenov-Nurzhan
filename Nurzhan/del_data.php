...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="  r">
        <!-- <div id="coin-  r">  -->
          <!-- <a href="#"><img src="images/Career5.jpg" width="960" height="500" alt="" /> </a>  -->
          <!-- <a href="#"><img src="images/Career4.jpg" width="960" height="500" alt="" /> </a>  -->
          <!-- <a href="#"><img src="images/  3.jpg" width="960" height="500" alt="" /> </a>  -->
        <!-- </div> -->
      </div>
      <div class="menu_nav">
        <ul>
...
<html><head><title>Delite</title>
<link href="style_for_all.css" rel="stylesheet" type="text/css" />
			    <h2><span> Deleted Data  </span></h2>
...
$id=$_GET['id'];
$strSQL ="delete from profession_code WHERE Profession_code = '$id'";
$result=$mysqli->query($strSQL);


IF($result){
echo "Deleted";
echo "<br><a href='proftable.php'>Back</a>";
